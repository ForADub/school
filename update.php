	...
	<section id="dash-nav">
		<div class="dash-nav-container">
			...
			<div class="dash-profile">
				<h2>Profile</h2>
				<ul>
					<li><a class="v-pupil" href="dashboard.php">View Pupil</a></li>
			...
			<div class="dash-profile">
				<h2>Examination</h2>
				<ul>
					<li><a class="v-result" href="#">Student's results</a></li>
				</ul>
			</div>
			<div class="dash-profile">
				<h2>Registration</h2>
...
<!-- Overview of dashboard -->
		...
		<!-- <section id="pupil-info">
			...
			<div class="links">
				<a href="#">View All Pupil</a>
				<a href="#">View All Teachers</a>
				<a href="#">View Sudent's result</a>
			...
			<div class="table">
				<table>
					...
					<tr>
						...
						<td><?php echo "<a class='butn' href='#?student_id={$info["id"]}'>Update</a>"; ?></td>
				...
				<form action="data-check.php" method="POST">
					...
					<div class="name">
						<div class="p-fname">
							...
							<input type="text" value="<?php echo "{$infos['firstName']}"; ?>">
						</div>
						<div class="p-fname">
			...
			<div class="table">
				<table>
					...
					<tr>
						...
						<td><?php echo "<a href="#">Update</a>" ?></td>
					</tr>
				...
				<form action="teacher-check.php" method="POST">
					...
					<div class="name">
						...
						<div class="p-fname">
							...
							<input type="text" placeholder="Place of Birth" name="t_sub">
						</div>
					</div>
					<div class="name">
						<div class="p-fname">
